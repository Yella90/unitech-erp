...
router.get("/download/desktop/windows/update/latest.yml", homeController.downloadDesktopWindowsLatestMetadata);
router.get("/download/desktop/windows/update/:artifactName", homeController.downloadDesktopWindowsUpdateArtifact);
